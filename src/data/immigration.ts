...
export const migrationAgents: MigrationAgent[] = [
  ...
  {
    id: "mig-15",
    name: "Fast Lanes ایجنت (Intercept ۳۰ روزه)",
    country: "آلمان",
    note: "رهگیری سریع ۳۰ روزه مسیر §21 — ارسال هدفمند به انکوباتورهای آماده صدور نامه حمایت (FAST LANES · 30-DAY INTERCEPT)",
    source: "Websites-by-AI/Soh_visa_by_xprize",
    kind: "ai",
  },
  {
    id: "mig-16",
    name: "ایجنت ۹۰ روزه (The 90-Day Plan)",
    country: "آلمان",
    note: "نقشه راه ۱۳ هفته‌ای تهران تا برلین — زمان‌بندی گام‌به‌گام از پرونده تا پرواز (Wheels up in thirteen weeks)",
    source: "Websites-by-AI/Soh_visa_by_xprize",
    kind: "ai",
  },
  {
    id: "mig-17",
    name: "LegalDrafter ایجنت",
    country: "ترکیه",
    note: "تنظیم پیش‌نویس اسناد حقوقی مهاجرت و قراردادها — از ریپوی شاهرخ",
    source: "SBZ-EDU/shahrokh-immigration-turkey",
    kind: "ai",
  },
  {
    id: "mig-18",
    name: "BusinessAnalyzer ایجنت",
    country: "ترکیه",
    note: "تحلیل کسب‌وکار و سرمایه‌گذاری برای مسیر کاری/ثبت شرکت در ترکیه",
    source: "SBZ-EDU/shahrokh-immigration-turkey",
    kind: "ai",
  },
  {
    id: "mig-19",
    name: "NewsSummarizer ایجنت",
    country: "جهانی",
    note: "خلاصه‌سازی اخبار و قوانین مهاجرت از منابع عمومی — گزارش سریع روزانه",
    source: "SBZ-EDU/shahrokh-immigration-turkey",
    kind: "ai",
  },
  {
    id: "mig-20",
    name: "StartupShowcase / Investor ایجنت",
    country: "آلمان و ترکیه",
    note: "ویترین استارتاپ و جذب سرمایه‌گذار برای ویزای §21 و برنامه‌های سرمایه‌گذاری",
    source: "SBZ-EDU/shahrokh-immigration-turkey + Soh_visa",
    kind: "ai",
  },
];

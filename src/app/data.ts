...
export type Seller = {
  ...
  city: string;
  zone: string;
  country?: string; // optional — defaults to "ایران" in the UI
  type: SellerType;
...
export const sellers: Seller[] = [
  ...
  { id: 12, name: "گیلان تهویه سبز", shortName: "GT", city: "رشت", zone: "شهر صنعتی رشت", type: "household", production: "مونتاژ", products: ["فن کویل", "هواکش EC", "فن کم‌صدا"], power: "35–350 W", powerMax: 350, voltage: "24–220 V", voltageClass: "low", score: 82, catalog: true, verified: true, lat: 37.28, lng: 49.58, mapX: 39, mapY: 34, contact: "gilanhvac.example", updated: "۲ روز پیش", source: "وب‌سایت عمومی", country: "ایران" },
  { id: 13, name: "مهرگستر پارس تهران", shortName: "MP", city: "تهران", zone: "شهرک صنعتی چهاردانگه", type: "industrial", production: "تولید محلی", products: ["موتور صنعتی BLDC", "درایو ولتاژ بالا", "ژنراتور کوچک"], power: "1.5–18.5 kW", powerMax: 18500, voltage: "220–380 V", voltageClass: "high", score: 85, catalog: true, verified: true, lat: 35.68, lng: 51.39, mapX: 52, mapY: 48, contact: "mehrgostar.example", updated: "امروز", source: "وب‌سایت و کاتالوگ عمومی", country: "ایران" },
  { id: 14, name: "کویر الکترو یزد", shortName: "KE", city: "یزد", zone: "شهرک صنعتی یزد", type: "household", production: "مونتاژ", products: ["فن خنک‌کننده", "موتور کولر BLDC", "کنترلر دور"], power: "25–160 W", powerMax: 160, voltage: "12–48 V", voltageClass: "low", score: 74, catalog: true, verified: true, lat: 31.9, lng: 54.37, mapX: 63, mapY: 70, contact: "kavirelectro.example", updated: "۳ روز پیش", source: "دایرکتوری صنعتی عمومی", country: "ایران" },
  { id: 15, name: "فناوران جنوب شیراز", shortName: "FJ", city: "شیراز", zone: "شهرک صنعتی بزرگ شیراز", type: "both", production: "تولید محلی", products: ["سروو موتور BLDC", "درایو FOC", "پمپ خورشیدی"], power: "200 W–4 kW", powerMax: 4000, voltage: "48–380 V", voltageClass: "high", score: 83, catalog: true, verified: true, lat: 29.59, lng: 52.58, mapX: 55, mapY: 78, contact: "fanaavaran-jonub.example", updated: "امروز", source: "نمایشگاه صنعت فارس", country: "ایران" },
  { id: 16, name: "آذر الکتریک تبریز", shortName: "AE", city: "تبریز", zone: "شهرک صنعتی شهید سلیمی", type: "industrial", production: "تولید محلی", products: ["موتور جرثقیل", "درایو صنعتی", "سیم‌پیچی سفارشی"], power: "0.75–11 kW", powerMax: 11000, voltage: "220–380 V", voltageClass: "high", score: 80, catalog: true, verified: true, lat: 38.07, lng: 46.3, mapX: 20, mapY: 24, contact: "azar-electric.example", updated: "۴ روز پیش", source: "وب‌سایت فنی عمومی", country: "ایران" },
  { id: 17, name: "خزر فن گیلان", shortName: "KF", city: "رشت", zone: "شهر صنعتی رشت", type: "household", production: "مونتاژ", products: ["هواکش EC", "فن سقفی BLDC", "کنترلر کم‌مصرف"], power: "30–300 W", powerMax: 300, voltage: "24–48 V", voltageClass: "low", score: 71, catalog: false, verified: true, lat: 37.27, lng: 49.6, mapX: 40, mapY: 32, contact: "public listing", updated: "هفته پیش", source: "اطلاعات عمومی اتحادیه", country: "ایران" },
  { id: 18, name: "موتورسازان اروند آبادان", shortName: "MA", city: "آبادان", zone: "ناحیه صنعتی اروند", type: "industrial", production: "تولید محلی", products: ["پمپ صنعتی", "موتور ضد انفجار", "درایو سفارشی"], power: "2.2–22 kW", powerMax: 22000, voltage: "380 V", voltageClass: "high", score: 77, catalog: true, verified: false, lat: 30.34, lng: 48.3, mapX: 37, mapY: 76, contact: "arvand-motor.example", updated: "۵ روز پیش", source: "کاتالوگ عمومی نمایشگاه", country: "ایران" },
  { id: 19, name: "کرمان موتور کویر", shortName: "KM", city: "کرمان", zone: "شهرک صنعتی کرمان", type: "both", production: "مونتاژ", products: ["موتور هاب", "پمپ کشاورزی", "کنترلر MPPT"], power: "250 W–5.5 kW", powerMax: 5500, voltage: "48–380 V", voltageClass: "high", score: 72, catalog: true, verified: true, lat: 30.28, lng: 57.08, mapX: 68, mapY: 74, contact: "kerman-kavir.example", updated: "۶ روز پیش", source: "دایرکتوری کسب‌وکار", country: "ایران" },
  { id: 20, name: "البرز درایو کرج", shortName: "AD", city: "کرج", zone: "شهرک صنعتی بهارستان", type: "industrial", production: "تولید محلی", products: ["درایو FOC", "موتور اسپیندل", "برد سنسور هال"], power: "0.4–7.5 kW", powerMax: 7500, voltage: "48–220 V", voltageClass: "high", score: 81, catalog: true, verified: true, lat: 35.84, lng: 50.94, mapX: 49, mapY: 47, contact: "alborz-drive.example", updated: "۲ روز پیش", source: "وب‌سایت فنی عمومی", country: "ایران" },
  { id: 21, name: "زاگرس پمپ لرستان", shortName: "ZP", city: "خرم‌آباد", zone: "شهرک صنعتی شماره ۲", type: "household", production: "مونتاژ", products: ["بوستر پمپ", "پمپ خانگی BLDC", "کنترلر هوشمند"], power: "60–750 W", powerMax: 750, voltage: "24–48 V", voltageClass: "low", score: 68, catalog: false, verified: true, lat: 33.49, lng: 48.36, mapX: 44, mapY: 64, contact: "public listing", updated: "۸ روز پیش", source: "اطلاعات عمومی اتحادیه", country: "ایران" },
  { id: 22, name: "مهرگان حرکت مشهد", shortName: "MH", city: "مشهد", zone: "شهرک صنعتی توس", type: "both", production: "واردات + مونتاژ", products: ["موتور هاب", "دوچرخه برقی", "کنترلر EV"], power: "250 W–3 kW", powerMax: 3000, voltage: "36–220 V", voltageClass: "low", score: 79, catalog: true, verified: true, lat: 36.3, lng: 59.6, mapX: 80, mapY: 42, contact: "mehregan-harkat.example", updated: "امروز", source: "فروشگاه آنلاین عمومی", country: "ایران" },
  { id: 23, name: "نیان موتور (Nian Motor)", shortName: "NIAN", city: "مشهد", zone: "پارک علم و فناوری / توس", type: "both", production: "تولید محلی", products: ["موتور BLDC کولری", "درایو اینورتر FOC", "فن و تهویه کم‌مصرف IE4/IE5"], power: "150 W–1.5 kW", powerMax: 1500, voltage: "180–265 VAC / 48V", voltageClass: "high", score: 95, catalog: true, verified: true, lat: 36.42, lng: 59.51, mapX: 79, mapY: 43, contact: "nianmotor.ir", updated: "ممیزی RAG کاتالوگ 2025", source: "https://nianmotor.ir/wp-content/uploads/2025/08/Nian-Motor-Catalog.pdf" },
];
